...
import com.karthee.chatapp.MApplication
import com.karthee.chatapp.core.*
...
import com.karthee.chatapp.fcmsender.FCMSender
import com.karthee.chatapp.fragments.group_chat_home.AdGroupChatHome
import com.karthee.chatapp.fragments.single_chat_home.AdSingleChatHome
import com.karthee.chatapp.models.Contact
...
import com.karthee.chatapp.ui.activities.ActSplash
...
object UserUtils {
    ...
    fun fetchContacts(context: Context): List<Contact> {
        ...
        while (cursor!!.moveToNext()) {
            ...
            if(number.contains(preference.getEmail()!!))
                continue
